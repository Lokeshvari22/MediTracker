...
3.  **Install the required dependencies:**
    The project includes a `requirement.txt` listing known dependencies. Install them with:
    ```bash
...
This repository includes basic unit/integration tests under `tests/`.
...
Note: Tests assume a working virtual environment with the dependencies installed.
