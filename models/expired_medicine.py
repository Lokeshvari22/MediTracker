...
class ExpiredMedicine(db.Model):
    ...
    original_value = db.Column(db.Float, default=0.0)

    loss_amount = db.Column(db.Float, default=0.0)
    ...
    medicine_id = db.Column(
        db.Integer,
        db.ForeignKey("medicines.id", ondelete="SET NULL"),
        nullable=True
    )
    ...
    def to_dict(self):
        return {
            ...
            "expired_date": str(self.expired_date) if self.expired_date else None,
