...
class ExpiryAnalysis:
    ...
    # ==================================
    # Critical Medicines (Low Stock & Expiring Soon)
    # ==================================
    ...
    def summary(user_id):
        return {
            "expired": ExpiryAnalysis.total_expired(user_id),
            "expiring": ExpiryAnalysis.total_expiring(user_id),
            "expired_value": ExpiryAnalysis.expired_value(user_id),
            "expiring_value": ExpiryAnalysis.expiring_value(user_id)
        }